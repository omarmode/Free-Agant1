    ...
    <header className="invoice-header">
      <div className="d-flex align-items-center">
        <Dropdown>
          <Dropdown.Toggle
            as={Link}
            to="#"
            className="invoiceapp-title link-dark"
          >
            <h1>All Bills</h1>
          </Dropdown.Toggle>
          <Dropdown.Menu>
      ...
      <div className="invoice-options-wrap">
        ...
        <Dropdown>
          <Dropdown.Toggle
            as="a"
            className="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover no-caret ms-0  d-sm-inline-block d-none"
          >
            <span
              className="icon"
...
export default connect(mapStateToProps, { toggleTopNav })(InvoiceAppHeader);
