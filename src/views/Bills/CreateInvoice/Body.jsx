...
const Body = () => {
  ...
  const updateItemList = (index) => (e) => {
    ...
    if (newArr[index].discountType === "per") {
      let disc =
        ...
        (itemList[index].price * itemList[index].discount) / 100;
  ...
  useEffect(() => {
    const CountSubtotal = itemList.reduce(
      (ttl, datas) => (ttl = ttl + datas.totalPrice),
      0
    );
    setSubTotal(CountSubtotal);
    const disct = itemList.reduce(
      (ttl, datas) => (ttl = ttl + parseInt(datas.discount)),
      0
    );
  ...
  return (
    <>
            ...
            <div className="create-invoice-wrap mt-xxl-5 p-md-5 p-3">
              <Row>
                ...
                <Col
                  lg={4}
                  md={4}
                  className="offset-lg-5 offset-md-3 mb-md-0 mb-4"
                >
                  <span className="d-flex align-items-center justify-content-md-end mb-0 inline-editable-wrap">
                    <HkInlineEdit as="h2" id="editable1" value="Bills" left />
                  </span>
                </Col>
              </Row>
              <Row className="mt-5">
                  ...
                  <Form>
                    <Row className="gx-3">
                      <Col lg={6} as={Form.Group} className="mb-3">
                        <Form.Control defaultValue="Bills No*" type="text" />
                      </Col>
                      <Col lg={6} as={Form.Group} className="mb-3">
                    ...
                    <Row className="gx-3">
                      <Col lg={6} as={Form.Group} className="mb-3">
                        <Form.Control defaultValue="Bills Date*" type="text" />
                      </Col>
                      <Col lg={6} as={Form.Group} className="mb-3">
                        <Form.Control
                          name="single-date-pick"
                          defaultValue="24/2/2020"
                          type="text"
                        />
                      </Col>
                    </Row>
                ...
                <Col xxl={4} className="offset-xxl-5">
                  ...
                  <div className="repeater">
                    ...
                    <a
                      ...
                      className="d-inline-flex align-items-center"
                    >
                      <i className="ri-add-box-line me-1" /> Add shipping
                      address
                    </a>
                  </div>
                </Col>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          >
                            <Form.Control
                              type="text"
                              className="bg-transparent border-0 p-0 total"
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="rounded-top-end border-bottom-0 w-30 bg-primary-light-5">
                            <Form.Control
                              type="text"
                              className="bg-transparent border-0 p-0 gross-total"
                              value={subTotal}
                              readOnly
                            />
                          </td>
                        ...
                        <tr>
                          ...
                          <td className="border-bottom-0  bg-primary-light-5">
                            <Form.Control
                              type="text"
                              className="bg-transparent border-0 p-0 gross-discount"
                              value={totalDiscount}
                              readOnly
                            />
                          </td>
                        ...
                        <tr>
                          ...
                          <td className="border-end-0 border-bottom-0 w-25">
                            <Form.Control
                              type="text"
                              className="extdiscount"
                              name="discValue"
                              value={extraDiscount.discValue}
                              onChange={(e) =>
                                setExtraDiscount({
                                  ...extraDiscount,
                          ...
                          <td className="border-bottom-0  bg-primary-light-5">
                            <Form.Control
                              type="text"
                              className="bg-transparent border-0 p-0 extdiscount-read"
                              value={extraDiscount.discValue}
                              readOnly
                            />
                          </td>
                        ...
                        <tr>
                          ...
                          <td className="rounded-bottom-end  bg-primary-light-5">
                            <Form.Control
                              type="text"
                              className="bg-transparent border-0 p-0 totalPrice"
                              value={grossTotal}
                              readOnly
                            />
                          </td>
              ...
              <Row className="mt-4">
                ...
                <Col
                  xxl={4}
                  className="offset-xxl-3 text-xxl-end mb-xxl-0 mb-3"
                >
                  <div className="btn btn-light btn-link text-primary btn-file bg-transparent p-0 border-0">
                    <span className="d-inline-flex align-items-center">
                      <i className="ri-add-box-line me-1" /> Add signature
                      (Optional)
                  ...
                  <div>
                    <a
                      ...
                      href="#label_collpase"
                    >
                      <i className="ri-add-box-line me-1" /> Add Name &amp;
                      Label
                    </a>
                  </div>
                  <div className="collapse show mt-5" id="label_collpase">
                    <Form.Group className="form-group close-over">
                      <Form.Control
                        ...
                        defaultValue="Katherine Zeta Jones"
                      />
                    ...
                    <Form.Group className="form-group close-over">
                      <Form.Control
                        type="text"
                        className="form-control"
                        defaultValue="Co-founder Hencework"
                      />
                      <Button bsPrefix="btn-close" className="close-input">
                        <span aria-hidden="true">×</span>
                      </Button>
                  ...
                  {termAndConditions.map((datas, index) => (
                    <li className="form-group close-over" key={index}>
                      <Form.Control
                        type="text"
                        name="conditon"
                        value={datas.conditon}
                        onChange={updateTC(index)}
                      />
                      <Button
                        bsPrefix="btn-close"
                        className="close-input"
                        onClick={() => deleteCondition(datas.id)}
                      >
                        <span aria-hidden="true">×</span>
                      </Button>
                    </li>
      ...
      <AddNewClient
        show={addNewClient}
        hide={() => setAddNewClient(!addNewClient)}
      />
    </>
  );
};
